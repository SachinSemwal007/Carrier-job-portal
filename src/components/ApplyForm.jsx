      ...
      <div className="max-w-screen-md mx-auto p-6 bg-white  shadow-md"> 
        <div bg-teal-100> 
          <h2 className="text-2xl font-bold mb-4 p-4"> 
            Apply for Vacancy: 
            <span className="text-teal-900 px-2 rounded-md"> {checktitle(titlejob)}</span> 
          </h2> 
        </div> 
          ...
          {experiences.map((experience, index) => ( 
            <div key={index} className="flex flex-wrap p-3 border border-gray-300 rounded-lg bg-gray-100 mb-4"> 
              <div className="relative flex-1 min-w-[150px] mr-2 mb-2 mt-2"> 
                ...
                <input type="text" name="orgName" placeholder=" " value={experience.orgName} onChange={(e) => handleExperiencesChange(index, e)} required className="w-full border border-gray-300 rounded-md p-2" /> 
              </div> 
              ...
              <div className="relative flex-1 min-w-[150px] mr-2 mb-2 mt-2"> 
                <label className="absolute -top-3 left-2 bg-gray-100 px-1 text-gray-600 text-sm"> Scale of Type</label> 
              ...
              <div className="relative flex-1 min-w-[150px] mr-2 mb-2 mt-2"> 
                <label className="absolute -top-3 left-2 bg-gray-100 px-1 text-gray-600 text-sm"> Nature Of Duties</label> 
              ...
              <button type="button" onClick={() => removeExperience(index)} className="bg-red-600 text-white mr-2 mb-3 mt-2 p-2 rounded-md"> 
                Remove 
              </button> 
            </div> 
          ))} 
          ...
          <div className="mb-6"> 
            ...
            <div className="mb-4"> 
              ...
              <span className="text-red-500 text-sm"> 
                <strong>Note: </strong>If multiple certificates exist, combine them into a single PDF. 
              </span> 
            </div> 
