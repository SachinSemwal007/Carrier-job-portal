        ...
        <form onSubmit={handleSubmit}> 
          ...
          {courses.map((course, index) => ( 
            <div key={index} className="flex flex-wrap p-3 border border-gray-300 rounded-lg bg-gray-100 mb-4"> 
              ...
              <button type="button" onClick={() => removeCourse(index)} className="bg-red-600 text-white mr-2 mb-2 p-2 rounded-md"> 
                Remove 
              </button> 
            </div> 
          ))} 
          ...
          {experiences.map((experience, index) => ( 
            <div key={index} className="flex flex-wrap p-3 border border-gray-300 rounded-lg bg-gray-100 mb-4"> 
              ...
              <button type="button" onClick={() => removeExperience(index)} className="bg-red-600 text-white mr-2 mb-2 p-2 rounded-md"> 
                Remove 
              </button> 
            </div> 
          ))} 
          ...
          {references.map((reference, index) => ( 
            <div key={index} className="flex flex-wrap p-3 border border-gray-300 rounded-lg bg-gray-100 mb-4"> 
              ...
              <input type="text" name="refRelation" placeholder="Relation" value={reference.refRelation} onChange={(e) => handleReferencesChange(index, e)} required className="mr-2 mb-2 p-2 border border-gray-300 rounded-md flex-1 min-w-[150px]" /> 
              <button type="button" onClick={() => removeReference(index)} className="bg-red-600 text-white mr-2 mb-2 p-2 rounded-md"> 
                Remove 
              </button> 
            </div> 
          ))} 
