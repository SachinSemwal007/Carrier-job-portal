      ...
      <div className={`lg:flex items-center space-x-4 ${isOpen ? "block" : "hidden"}`}>
        ...
        {applicant ? (
          <div className="flex gap-2">
            ...
            <Link href="/applicant-dashboard" className="block mt-2 lg:mt-0 px-2 py-1 rounded hover:bg-[#44403c] transition duration-300">
              Applicant Dashboard
            </Link>
          </div>
        ) : (
          <Link href="/login" className="block mt-2 lg:mt-0 px-2 py-1 rounded hover:bg-[#44403c] transition duration-300">
            Login
          </Link>
        )}
      </div>
